...
# 项目信息
sys.path.insert(0, os.path.abspath('.'))
project = 'AISBench 评测工具'  # 这里设置你的 project name
copyright = '2025, AISBench人工智能系统性能评测基准委员会'  # 修改为实际的版权信息
author = 'AISBench人工智能系统性能评测基准委员会'  # 修改为实际的作者名称

# 1. 配置文档主题（使用 RTD 官方主题，适配托管后风格）
